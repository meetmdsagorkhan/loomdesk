...
function ResetPasswordContent() {
  ...
  return (
    <div className="glass-card rounded-2xl p-8">
      ...
      {successMessage && (
        <div className="bg-emerald-50/80 dark:bg-emerald-950/20 text-emerald-600 dark:text-emerald-300 px-4 py-3 rounded-xl text-sm mb-6 flex items-center gap-3 backdrop-blur-sm">
