  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav: cn(
          "relative flex w-full items-center justify-between gap-1 mb-2",
...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      className={cn(
        "relative isolate z-10 flex aspect-square size-auto w-full min-w-(--cell-size) flex-col gap-1 border-0 leading-none font-normal group-data-[focused=true]/day:relative group-data-[focused=true]/day:z-10 group-data-[focused=true]/day:border-ring group-data-[focused=true]/day:ring-[3px] group-data-[focused=true]/day:ring-ring/50 data-[range-end=true]:rounded-(--cell-radius) data-[range-end=true]:rounded-r-(--cell-radius) data-[range-end=true]:!bg-[#a855f7] data-[range-end=true]:!text-white data-[range-middle=true]:rounded-none data-[range-middle=true]:!bg-[#a855f7]/20 data-[range-middle=true]:!text-[#a855f7] data-[range-start=true]:rounded-(--cell-radius) data-[range-start=true]:rounded-l-(--cell-radius) data-[range-start=true]:!bg-[#a855f7] data-[range-start=true]:!text-white data-[selected-single=true]:!bg-[#a855f7] data-[selected-single=true]:!text-white data-[selected-single=true]:shadow-[0_4px_12px_rgba(168,85,247,0.4)] data-[outside-selected=true]:!bg-transparent data-[outside-selected=true]:!text-muted-foreground data-[outside-selected=true]:!opacity-50 data-[today=true]:!border-2 data-[today=true]:!border-[#a855f7] data-[holiday=true]:after:content-[''] data-[holiday=true]:after:absolute data-[holiday=true]:after:bottom-1 data-[holiday=true]:after:left-1/2 data-[holiday=true]:after:-translate-x-1/2 data-[holiday=true]:after:w-1.5 data-[holiday=true]:after:h-1.5 data-[holiday=true]:after:bg-[#a855f7] data-[holiday=true]:after:rounded-full dark:hover:text-foreground [&>span]:text-xs [&>span]:opacity-70",
        defaultClassNames.day,
        className
      )}
      {...props}
